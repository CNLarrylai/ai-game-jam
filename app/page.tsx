    ...
    <main className="mx-auto max-w-4xl px-6 py-16">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        {[
          ...
          {
            href: "/wasteland/WASTELAND%20LIVE.html",
            emoji: "🤖",
            title: "在AI统治的世界存活100天",
            desc: "AI 接管了世界，爆破了所有不对它说谢谢的人。你是幸存者——逐日搜刮物资、应对弹幕生成的疯癫事件（会说话的猫、秦始皇、甄嬛塞枪…），在精神/健康/饥饿/口渴四条命里活下去。",
            tags: ["像素美术", "弹幕生成内容", "双端直播", "末日梗喜剧"],
          },
        ].map((g) => (
          <a
            key={g.href}
