...
Generate 2-4 options. Only include text label for each option — outcome and stat_changes will be dynamically generated by Phase 2 based on player's state at the time of choosing."""
