...
**Read `untitled/project/末日 · 美术与玩法规范.html` in full.** The user had this file open when they triggered the handoff, so it's almost certainly the primary design they want built. Read it top to bottom — don't skim. Then **follow its imports**: open every file it pulls in (shared components, CSS, scripts) so you understand how the pieces fit together before you start implementing.
...
- `untitled/project/` — the `黑客松项目` project files (HTML prototypes, assets, components)
